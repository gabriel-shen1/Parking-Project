...
public class Lots {
    ...
    String _name;
    int _campus; //1 busch, 2 livi, 3 college
    ...
    public Lots(int _id, String _name, int _campus, int _faculty, int _curr) {
        this._id = _id;
        this._name = _name;
    ...
    public int get_campus() {
        return _campus;
    }

    public void set_campus(int _campus) {
        this._campus = _campus;
    }
