...
public class Students {
    ...
    String _name;
     ...
     int tmplot; // access to this lot tmp
     String password;
    ...
    Initialize data
     */
    public Students(String _email, int _id, String _name, String surname, int lot, int tmplot, String password, int day, int faculty) {
        this._email = _email;
        this._id = _id;
        this._name = _name;
    ...
    public int getTmplot() {
        return tmplot;
    }

    public void setTmplot(int tmplot) {
        this.tmplot = tmplot;
    }
