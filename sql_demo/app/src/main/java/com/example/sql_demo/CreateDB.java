...
public class CreateDB {
    ...
    public CreateDB(Context context) {
        ...
        Ldb = new LotsDbHandler(context);
         ...
         s1 = new Students("ss2@scarletmail.rutgers.edu", 145002121, "jerry", "finn",1,0,"psw1",-1,-1);

        s2 = new Students("ss3@scarletmail.rutgers.edu", 146004121, "max", "finn",2,0,"psw2",-1,-1);

         s3 = new Students("ss4@scarletmail.rutgers.edu", 145007721, "hal", "finn",3,0,"psw3",-1,-1);

        f1 = new Students("ss5@scarletmail.rutgers.edu", 145008721, "marsic", "finn",3,0,"psw3",-1,1);

         b1 = new Lots(1,"buschLotA",1,-1,58);
         b2 = new Lots(2,"buschLotB",1,-1,51);
         b3 = new Lots(3,"buschLotC",1,-1,46);



         a1 = new Lots(4,"LiviLotA",2,-1,44);
         a2 = new Lots(5,"LiviLotB",2,-1,56);
         a3 = new Lots(6,"LiviLotC",2,-1,48);

         c1 = new Lots(7,"ColLotA",3,-1,40);
         c2 = new Lots(8,"ColLotB",3,-1,51);
         c3 = new Lots(9,"ColLotC",3,-1,49);

        bf1 = new Lots(10,"fbuschLotA",1,1,31);
        lf1 = new Lots(11,"fLiviLotA",1,-1,33);
        ...
        initFacLots(bf1,lf1);
        boolean x;
         x = Ldb.insertDataLot(b1);
         x = Ldb.insertDataLot(b2);
         x = Ldb.insertDataLot(b3);
         x = Ldb.insertDataLot(a1);
         x = Ldb.insertDataLot(a2);
         x = Ldb.insertDataLot(a3);
         x = Ldb.insertDataLot(c1);
         x = Ldb.insertDataLot(c2);
         x = Ldb.insertDataLot(c3);
         x = Ldb.insertDataLot(bf1);
         x = Ldb.insertDataLot(lf1);

         x = db.insertDataStudent(s1);
         x = db.insertDataStudent(s2);
         x = db.insertDataStudent(s3);
